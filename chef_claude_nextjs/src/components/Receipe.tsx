...
const Recipe = (props: { recipe: string}) => {
  ...
  return (
    <section>
      <h2 className="text-3xl font-semibold mb-5 underline">Chef Claude Recommends:</h2>
      <article className="text-[#475467] text-lg" aria-live="polite">
        {/* {props.recipe} */}
        <Markdown className="prose lg:prose-xl">{props.recipe}</Markdown>
      </article>
    </section>
  );
};
